    ...
    plugin(function ({ addVariant, prefix, e }) {
          ...
          return selectorParser((selectors) => {
            selectors.walkClasses((sel) => {
              ...
              sel.parent.insertBefore(
                sel,
                selectorParser().astSync(prefix('.dark '))
              )
            })
      ...
      addVariant('dark-hover', ({ modifySelectors, separator }) => {
        modifySelectors(({ className }) => {
          return `.dark .${e(`dark-hover${separator}${className}`)}:hover`
        })
      })

      addVariant('dark-focus', ({ modifySelectors, separator }) => {
        modifySelectors(({ className }) => {
          return `.dark .${e(`dark-focus${separator}${className}`)}:focus`
        })
      })
    }),
